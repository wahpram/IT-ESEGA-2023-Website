...
@section('content')
    ...
    <section id="contact" class="contact mt-5">
        <div class="container" data-aos="fade-up">
            ...
            <form action="mole-player-regis/{{ $id }}" method="POST" role="form" class="form" enctype="multipart/form-data">
                @csrf
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="idserver" class="form-control" id="idserver" placeholder="Contoh : 38238181(2059)" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="nohp">No Hp</label>
                                        <input type="tel" class="form-control" name="nohp" id="nohp" placeholder="Contoh : 081234567890" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="idserver2" class="form-control" id="idserver2" placeholder="Contoh : 38238181(2059)" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="nohp2">No Hp</label>
                                    <input type="tel" class="form-control" name="nohp2" id="nohp2" placeholder="Contoh : 38238181(2059)" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="idserver3" class="form-control" id="idserver3" placeholder="Contoh : 38238181(2059)" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="nohp3">No Hp</label>
                                    <input type="tel" class="form-control" name="nohp3" id="nohp3" placeholder="Contoh : 081234567890" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="nick4" id="nick4" placeholder="Contoh : Alex"s required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="idserver4">Server</label>
                                    <input type="text" name="idserver4" class="form-control" id="idserver4" placeholder="Contoh : 38238181(2059)" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="nohp4">No Hp</label>
                                    <input type="tel" class="form-control" name="nohp4" id="nohp4" placeholder="Contoh : 081234567890" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="idserver5" class="form-control" id="idserver5" placeholder="Contoh : 38238181(2059)" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="nohp5">No Hp</label>
                                    <input type="tel" class="form-control" name="nohp5" id="nohp5" placeholder="Contoh : 081234567890" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="email5">Email</label>
                                    <input type="email" class="form-control" name="email5" id="email5" placeholder="Contoh : alex12@gmail.com" required>
                                </div>
                                <div class="form-group col-md-6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="idserver6" class="form-control" id="idserver6" placeholder="Contoh : 38238181(2059)" >
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="nohp6">No Hp</label>
                                    <input type="tel" class="form-control" name="nohp6" id="nohp6" placeholder="Contoh : 081234567890" >
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="idserver7" class="form-control" id="idserver7" placeholder="Contoh : 38238181(2059)" >
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="nohp7">No Hp</label>
                                    <input type="tel" class="form-control" name="nohp7" id="nohp7" placeholder="Contoh : 081234567890" >
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
    ...
    <script>
        $('form[action="mole-player-regis/{{ $id }}"]').on('submit', function () {
