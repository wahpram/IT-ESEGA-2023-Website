  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>MASKOT IT-ESEGA 2023</h2>
        </div>

        <div class="row content">
          <div class="col-lg-6 float-left">
            <div class="d-flex justify-content-center">
              <img src="{{ URL('/assets/img/Maskot.png') }}" width="500px" alt="">
            </div>
          </div>
...
{{-- 
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-xl d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
          ...
          <div class="col-xl col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
